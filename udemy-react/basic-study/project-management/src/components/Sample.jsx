...
function TravelAlarmLogger() {
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      const apiKey = '9fIx1vb4ANg2QMY7AKFtKxpKT7xD5kvBd%2B7hMfrxUh5uo7YlQBsRzRUpGXiRF%2BuQRtAO%2F116PJ7hwR76BJ2sPQ%3D%3D';
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <label>
          ...
          <input type="text" value={continentName} onChange={handleInputChange} />
        </label>
